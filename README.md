...
[**Fibonacci Sequence**](https://github.com/tailnode/Projects/tree/master/Numbers/fibonacci.py) - Enter a number and have the program generate the Fibonacci sequence to that number or to the Nth number.
...
[**Change Return Program**](https://github.com/tailnode/Projects/tree/master/Numbers/change_return.py) - The user enters a cost and then the amount of money given. The program will figure out the change and the number of quarters, dimes, nickels, pennies needed for the change.

[**Binary to Decimal and Back Converter**](https://github.com/tailnode/Projects/tree/master/Numbers/binary_decimal.py) - Develop a converter to convert a decimal number to binary or a binary number to its decimal equivalent.

**Calculator** - A simple calculator to do basic operators. Make it a scientific calculator for added complexity.

**Unit Converter (temp, currency, volume, mass and more)** - Converts various units between one another. The user enters the type of unit being entered, the type of unit they want to convert to and then the value. The program will then make the conversion.

[**Alarm Clock**](https://github.com/tailnode/Projects/tree/master/Numbers/alarm_clock.py) - A simple clock where it plays a sound after X number of minutes/seconds or at a particular time.
...
[**Happy Numbers**](https://github.com/tailnode/Projects/tree/master/Numbers/happy_numbers.py) - A happy number is defined by the following process. Starting with any positive integer, replace the number by the sum of the squares of its digits, and repeat the process until the number equals 1 (where it will stay), or it loops endlessly in a cycle which does not include 1. Those numbers for which this process ends in 1 are happy numbers, while those that do not end in 1 are unhappy numbers. Display an example of your output here. Find first 8 happy numbers.
...
[**Collatz Conjecture**](https://github.com/tailnode/Projects/tree/master/Classic Algorithms/collatz_conjecture.py) - Start with a number *n > 1*. Find the number of steps it takes to reach one using the following process: If *n* is even, divide it by 2. If *n* is odd, multiply it by 3 and add 1.

[**Sorting**](https://github.com/tailnode/Projects/tree/master/Classic Algorithms/sorting.py) - Implement two types of sorting algorithms: Merge sort and bubble sort.
...
[**Reverse a String**](https://github.com/tailnode/Projects/tree/master/Text/reverse_a_string.py) - Enter a string and the program will reverse it and print it out.

**Pig Latin** - Pig Latin is a game of alterations played on the English language game. To create the Pig Latin form of an English word the initial consonant sound is transposed to the end of the word and an ay is affixed (Ex.: "banana" would yield anana-bay). Read Wikipedia for more information on rules.

**Count Vowels** - Enter a string and the program counts the number of vowels in the text. For added complexity have it report a sum of each vowel found.

[**Check if Palindrome**](https://github.com/tailnode/Projects/tree/master/Text/check_if_palindrome.py) - Checks if the string entered by the user is a palindrome. That is that it reads the same forwards as backwards like “racecar”

[**Count Words in a String**](https://github.com/tailnode/Projects/tree/master/Text/count_words.py) - Counts the number of individual words in a string. For added complexity read these strings in from a text file and generate a summary.
...
[**FTP Program**](https://github.com/tailnode/Projects/tree/master/Networking/simple_ftp_client.py) - A file transfer program which can transfer files back and forth from a remote web sever.
